...
const NAV_ITEMS = [
  { path: RoutePaths.DASHBOARD, label: 'Dashboard', icon: DashboardIcon },
  { path: RoutePaths.USERS, label: 'Users', icon: UsersIcon },
  { path: RoutePaths.GROUPS, label: 'Groups', icon: GroupsIcon },
  { path: RoutePaths.DOMAIN, label: 'Domain', icon: DomainIcon },
];
