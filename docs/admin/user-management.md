...
Manage Active Directory user accounts -- create, edit, enable/disable, delete, and organize users across organizational
units.
...
When editing, the **Username** field is read-only. The Unix Attributes section and the "Must change password at next
login" checkbox are not available during editing.

### Resetting a Password

On the edit form, enter a new value in the **New Password** field. Leave it blank to keep the current password. The
password is updated when you click **Save Changes**.
